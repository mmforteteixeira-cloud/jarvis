...
const STATE_STYLES: Record<JarvisOrbState, { ring: string; core: string; label: string }> = {
  ...
  error: { ring: "border-ink-faint/40", core: "bg-ink-faint", label: "OFFLINE" },
};
  ...
  return (
    <div className={`flex flex-col items-center gap-3 ${className}`}>
      <div className="relative shrink-0" style={{ width: size, height: size }}>
        ...
        <div
          className={`absolute inset-[36%] rounded-full ${styles.core} ${active ? "animate-jarvis-breathe" : "animate-jarvis-pulse"} opacity-90`}
